...
export default function Gallery({ onSelectTrack }: GalleryProps) {
  const { getAllTracks, likeTrack, loading } = useTrackAPI();
  ...
  const handleLike = async (trackId: string) => {
    ...
    const updatedTrack = await likeTrack(trackId);
    if (updatedTrack) {
      setTracks((prev) =>
            ...
            {tracks.map((track) => (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-[#00FFFF] text-sm mb-2">{track.author || "Artist"}</p>
                ...
                <div className="flex items-center justify-between mb-4 pt-4 border-t border-[#FF00FF]/30">
                  ...
                  <Button
                    ...
                    disabled={likedTracks.has(track.id)}
                    className={`${
